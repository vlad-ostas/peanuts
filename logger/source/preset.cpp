...
const LoggerConfig defaults_verbose { Level::Verbose, Color::DarkBlue,   true,            true,             true             };
const LoggerConfig defaults_debug   { Level::Debug,   Color::LightBlue,  true,            true,             true             };
...
Logger verbose(std::cout, defaults_verbose);
